...
.config(function ($stateProvider, $urlRouterProvider, $translateProvider) {
	...
	$translateProvider.translations('it', {
		...
		registration_password: 'Password (al meno 6 caratteri)',
	...
	$translateProvider.translations('en', {
		...
		register_error: 'Registration error. Check the data and retry later',
		...
		registration_email: 'Email',
		registration_password: 'Password (at least 6 characters)',
