...
.config(function ($stateProvider, $urlRouterProvider, $translateProvider) {
	...
	$translateProvider.translations('it', {
		...
		credits_project: 'Sviluppato da:',
		credits_sponsored: 'Con la collaborazione di:',
		credits_info: 'Per informazioni:',
		credits_thanks: 'Un ringraziamento particolare agli studenti e agli insegnanti del Liceo A. Rosmini e ai giovani in servizio civile presso le Politiche giovanili del Comune di Trento che hanno contribuito a produrre i dati visualizzati nella app.',
