...
.config(function ($stateProvider, $urlRouterProvider, $translateProvider) {
    ...
    $translateProvider.translations('de', {
        ...
        pathdetailturist_review_hint: 'Posten Sie Ihre Bewertung',
        pathdetailturist_review: 'Bewertung',
        pathdetailturist_voteinfo: 'Bewerten Sie den Weg',
        pathdetailtourist_empty_list: 'Leere Liste',
        pathdetailtourist_anonymous: 'Anonym',
        pathdetailtourist_your_review: 'Ihre Rezension',
        ...
        review_sent_toast_ok: 'Bewertung aufgezeichnet',
        addImage_popup_ok: 'OK',
        addImage_popup_cancel: 'Schließen',
        addImage_label: 'Fügen Sie ein Bild',
        addImage_isEmpty: 'fügen Sie ein Bild',
