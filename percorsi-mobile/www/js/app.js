...
.config(function ($stateProvider, $urlRouterProvider, $translateProvider) {
    ...
    $translateProvider.translations('it', {
        ...
        path_map: 'Mappa',
        path_turist: 'Turista',
        path_difficulty_1: 'Difficolt&agrave; bassa',
        path_difficulty_2: 'Difficolt&agrave; media',
        path_difficulty_3: 'Difficolt&agrave; alta',
    ...
    $translateProvider.translations('en', {
        ...
        path_map: 'Map',
        path_turist: 'Tourist',
        path_difficulty_1: 'Low difficulty',
        path_difficulty_2: 'Medium difficulty',
        path_difficulty_3: 'Hard difficulty',
        credits_title: 'Credits',
